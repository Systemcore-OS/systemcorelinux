savedcmd_arch/arm64/kernel/vdso/vgetrandom-chacha.o := /home/runner/work/buildroot/buildroot/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-gcc -Wp,-MMD,arch/arm64/kernel/vdso/.vgetrandom-chacha.o.d -nostdinc -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -DCC_USING_PATCHABLE_FUNCTION_ENTRY -DKASAN_SHADOW_SCALE_SHIFT= -fmacro-prefix-map=./= -D__ASSEMBLY__ -fno-PIE -mabi=lp64 -fno-asynchronous-unwind-tables -fno-unwind-tables -DKASAN_SHADOW_SCALE_SHIFT=    -c -o arch/arm64/kernel/vdso/vgetrandom-chacha.o arch/arm64/kernel/vdso/vgetrandom-chacha.S 

source_arch/arm64/kernel/vdso/vgetrandom-chacha.o := arch/arm64/kernel/vdso/vgetrandom-chacha.S

deps_arch/arm64/kernel/vdso/vgetrandom-chacha.o := \
...
arch/arm64/kernel/vdso/vgetrandom-chacha.o: $(deps_arch/arm64/kernel/vdso/vgetrandom-chacha.o)
