...
#define TSK_STACK_CANARY 1424 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 6864 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 8512 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 8408 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 8488 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 8504 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define MM_CONTEXT_ID 1048 /* offsetof(struct mm_struct, context.id.counter) */
...
#define PAGE_SZ 16384 /* PAGE_SIZE */
...
#define TRAMP_VALIAS -10616832 /* TRAMP_VALIAS */
