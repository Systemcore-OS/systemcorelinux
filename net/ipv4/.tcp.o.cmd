...
deps_net/ipv4/tcp.o := \
  ...
  include/net/rps.h \
  net/ipv4/../core/devmem.h \
    $(wildcard include/config/NET_DEVMEM) \

net/ipv4/tcp.o: $(deps_net/ipv4/tcp.o)

$(deps_net/ipv4/tcp.o):
#SYMVER tcp_orphan_count 0x478e81f8
#SYMVER tcp_tw_isn 0x9cc92f1a
#SYMVER sysctl_tcp_mem 0xa0ebd14c
#SYMVER tcp_memory_allocated 0x59b4ac3e
